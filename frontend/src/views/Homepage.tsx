export default function Homepage() {
  return (
    ...
    <a href='/auth/homepage'>
    <img src="/images-home/logo_2.png" className="h-[7vmin] w-[28vmin] px-[0.9vmin]" alt="logo" />
    </a>
    <text> </text>

    <nav className="flex gap-5">
        <a className="text-black text-[16px] font-bold hover:underline" href="/">Inicio</a>
        <a className="text-black text-[16px] font-bold hover:underline" href="#">Servicios</a>
        <a className="text-black text-[16px] font-bold hover:underline" href="#">Productos</a>
        <a className="text-black text-[16px] font-bold hover:underline" href="#">Contacto</a>
    </nav>

    <div className="flex gap-2">
        <button className="bg-[#11214D] text-white border-none px-4 py-2 text-sm rounded-md hover:bg-white hover:text-[#11214D] hover:border hover:border-[#11214D]">Ingresar</button>
        <button className="bg-[#11214D] text-white border-none px-4 py-2 text-sm rounded-md hover:bg-white hover:text-[#11214D] hover:border hover:border-[#11214D]">Registrarse</button>
    </div>
    ...
    */}
    <img className="pt-8" src="https://placehold.jp/1600x500.png" alt="Imagen 1"/>

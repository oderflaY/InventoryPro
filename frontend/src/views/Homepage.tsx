    ...
    <>
      ...
      <section className="pt-20 flex justify-between items-center px-[75px] pr-[200px] bg-gray-100 ">
        <div className="max-w-1/2 space-y-2">
          <h1 className="text-[40px] font-bold">
            Inventory management <br></br> Now Simplified <br></br>{" "}
      ...
      <section className="text-center p-12 bg-white">
        ...
        <div className="inline-block text-left w-[30%] m-5 leading-[1.5] space-y-2">
          <img
            src="/images-home/logo_idk.png"
            className="w-[100px]"
            alt="logo"
          />
          <h3 className="font-bold">Multiple Inventories</h3>
          <p>Manage all the inventories you want from anywhere</p>
        </div>
        ...
        <div className="inline-block text-left w-[30%] m-5 leading-[1.5] space-y-2">
          ...
          <p>Update your inventories whenever you want. </p>
        </div>
        ...
        <div className="inline-block text-left w-[30%] m-5 leading-[1.5] space-y-2">
          ...
          <p>You won't have to worry about your inventories being leaked.. </p>
        </div>
      </section>
        ...
        <div className="flex justify-center gap-5 pt-5">
          ...
          <div className="bg-white p-5 rounded-lg shadow-md w-[400px] ">
            <div className="text-white bg-gradient-to-b from-[#1E3A8A] to-[#11214D] h-[140px] leading-[1.8] text-left pl-[30px] rounded-lg space-y-0.5">
              ...
              <div className="pt-1 pl-10">
                <a href="/memberships">
                  <button className="font-bold bg-white text-blue-700 border-1 border-transparent px-4 py-2 text-[15px] rounded-full w-[220px] hover:bg-[#11214D] hover:text-white hover:border-2 hover:border-white">
                    Choose this plan
                  </button>
                </a>
              </div>
            ...
            <ul className="mt-4 space-y-2 text-white">
              <div className="flex items-center pl-10 space-x-4">
                ...
                <li className="text-blue-900">One inventory</li>
              </div>
          ...
          <div className="bg-white p-5 rounded-lg shadow-md w-[400px]">
            <div className="text-white bg-gradient-to-b from-[#1E3A8A] to-[#11214D] h-[140px] leading-[1.8] text-left pl-[30px] rounded-lg space-y-0.5">
              ...
              <div className="flex">
                <p className="text-2xl pl-2">$20</p>
                <p className="text-1xl pt-1 pl-2 font-light italic">Month</p>
              </div>
              <div className="pt-1 pl-10">
                <a href="/memberships">
            ...
            <ul className="mt-4 space-y-2 text-white">
              <div className="flex items-center pl-10 space-x-4">
                <IoCheckmark className="text-green-500 w-6 h-6" />
                <li className="text-blue-900">Multiple inventories</li>
              </div>
          ...
          <div className="bg-white p-5 rounded-lg shadow-md w-[400px]">
            <div className="text-white bg-gradient-to-b from-[#1E3A8A] to-[#11214D] h-[140px] leading-[1.8] text-left pl-[30px] rounded-lg space-y-0.5">
              ...
              <div className="flex">
                <p className="text-2xl pl-2">$50</p>
                <p className="text-1xl pt-1 pl-2 font-light italic">Month</p>
              </div>
              <div className="pt-1 pl-10">
                <a href="/memberships">
            ...
            <ul className="mt-4 space-y-2 text-white">
              <div className="flex items-center pl-10 space-x-4">
                <IoCheckmark className="text-green-500 w-6 h-6" />
                <li className="text-blue-900">Multiple admins</li>
              </div>
      ...
      <div className="faq-containermax-w-[900px] mx-auto grid grid-cols-2 gap-4 text-center px-10">
        <h2 className="text-[24px] font-bold mb-5 col-span-2 pt-6">
        ...
        <details className="bg-white rounded-md p-4 shadow-md cursor-pointer transition ease-in-out border-l-4 border-transparent open:border-[#11214D]">
          ...
          <div className="mt-2 text-gray-500 text-sm">
            Can I add suppliers and manage their data?.
          </div>
        </details>
        ...
        <details className="bg-white rounded-md p-4 shadow-md cursor-pointer transition ease-in-out border-l-4 border-transparent open:border-[#11214D]">
          ...
          <div className="mt-2 text-gray-500 text-sm">
            Do you have an alert system for products with low stock?.
          </div>
        </details>
        ...
        <details className="bg-white rounded-md p-4 shadow-md cursor-pointer transition ease-in-out border-l-4 border-transparent open:border-[#11214D]">
          ...
          <div className="mt-2 text-gray-500 text-sm">
            Can I track incoming and outgoing products?.
          </div>
        </details>
        ...
        <details className="bg-white rounded-md p-4 shadow-md cursor-pointer transition ease-in-out border-l-4 border-transparent open:border-[#11214D]">
          ...
          <div className="mt-2 text-gray-500 text-sm">
            Is it possible to generate sales and inventory reports?.
          </div>
        </details>
      </div>
      ...
      <footer className="bg-white p-10 flex justify-between items-start">
        <div className="flex items-start">
          <img
            className="h-[7vmin] w-[28vmin] pl-[0.9vmin]"
            src="/images-home/logo_2.png"
          ...
          <div className="mt-2">
            <a href="#">
              <img
                ...
                src="/images-home/get-google.png"
                alt="Google Play"
              />
            </a>
            <a href="#">
